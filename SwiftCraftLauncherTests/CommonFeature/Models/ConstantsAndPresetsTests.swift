...
final class ConstantsAndPresetsTests: XCTestCase {
    ...
    func testYggdrasilServerPresets_littleSkin() {
        let littleSkin = YggdrasilServerPresets.servers.first { $0.name == "LittleSkin" }
    ...
    func testYggdrasilServerPresets_mua() {
        let mua = YggdrasilServerPresets.servers.first { $0.name == "Mua" }
        XCTAssertNotNil(mua)
    ...
    func testYggdrasilServerPresets_ely() {
        let ely = YggdrasilServerPresets.servers.first { $0.name == "Ely.By" }
        XCTAssertNotNil(ely)
    ...
    func testYggdrasilServerPresets_allHaveRedirectURI() {
        for server in YggdrasilServerPresets.servers {
