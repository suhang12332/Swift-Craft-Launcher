...
struct GameAdvancedSettingsView: View {
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    HStack {
                        Text("settings.game.java.memory.recommendation".localized())
                            .font(.caption)
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Toggle("settings.game.java.enable_jvm_optimization".localized(), isOn: $enableOptimizations)
                            .toggleStyle(SwitchToggleStyle()).controlSize(.mini).font(.subheadline)
                        
                        Toggle("settings.game.java.enable_aikar_flags".localized(), isOn: $enableAikarFlags)
                            .toggleStyle(SwitchToggleStyle())
                            .disabled(!enableOptimizations).controlSize(.mini).font(.subheadline)
                        Toggle("settings.game.java.enable_client_optimization".localized(), isOn: $enableClientOptimizations)
                            .toggleStyle(SwitchToggleStyle()).controlSize(.mini).font(.subheadline)
                            .disabled(!enableOptimizations)
                        
                        Toggle("settings.game.java.enable_memory_optimization".localized(), isOn: $enableMemoryOptimizations)
                            .toggleStyle(SwitchToggleStyle()).controlSize(.mini).font(.subheadline)
                            .disabled(!enableOptimizations)
                        
                        Toggle("settings.game.java.enable_thread_optimization".localized(), isOn: $enableThreadOptimizations)
                            .toggleStyle(SwitchToggleStyle()).controlSize(.mini).font(.subheadline)
                            .disabled(!enableOptimizations)
                    }
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Text("settings.game.java.jvm_args".localized() + " (每行一个参数):")
                        .font(.subheadline)
                        .foregroundColor(.secondary)
                    ...
                    Text("settings.game.java.custom_parameters.note".localized())
                        .font(.caption)
                        .foregroundColor(.orange)
                }
            }
    ...
    private func parseExistingJvmArguments(_ arguments: String) {
        ...
        enableAikarFlags = args.contains("-XX:+UseG1GC") && args.contains("-XX:+ParallelRefProcEnabled")
        enableClientOptimizations = args.contains("-XX:+UseCompressedOops")
        enableMemoryOptimizations = args.contains("-XX:+UseCompressedClassPointers")
