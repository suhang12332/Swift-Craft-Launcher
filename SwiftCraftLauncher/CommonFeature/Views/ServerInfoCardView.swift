...
/// 通用的服务器信息卡片组件，用于展示服务器详情
/// 适用于本地服务器和从Modrinth添加的在线服务器
struct ServerInfoCardView: View {
    // MARK: - Properties
    let title: String
    let description: String
    let icon: ServerInfoIcon
...
extension ServerInfoCardView {
    /// 从 MinecraftServerInfo 创建服务器信息卡片（用于本地服务器）
    init(
        serverName: String,
    ...
    /// 从 ModrinthProjectDetail 创建服务器信息卡片（用于在线服务器）
